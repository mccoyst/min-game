...
void test_bbox(Testo &t){
	...
	t.Assert(self, "self");
	t.Assert(self.overlap.x == b.size.x, "self.x");
	t.Assert(self.overlap.y == b.size.y, "self.y");
	...
	t.Assert(bc.overlap.x == b.size.x - Fixed{1}, "bc.x == b.x-1");
	t.Assert(bc.overlap.y == b.size.y - Fixed{1}, "bc.y == b.y-1");

	Vec2 world{ Fixed{10}, Fixed{10} };
	Isection wself = b.IsectWorld(world, b);
	t.Assert(wself, "wrap self");
	t.Assert(wself.overlap.x == b.size.x, "wrap self.x");
	t.Assert(wself.overlap.y == b.size.y, "wrap self.y");
	...
	t.Assert(wbc.overlap.x == b.size.x - Fixed{1}, "wrap bc.x == b.x-1");
	t.Assert(wbc.overlap.y == b.size.y - Fixed{1}, "wrap bc.y == b.y-1");
	...
	t.Assert(bd.overlap.x == b.size.x - Fixed{1}, "bd.x == b.x-1");
	t.Assert(bd.overlap.y == b.size.y - Fixed{1}, "bd.y == b.y-1");
	t.Assert(cd, "cd");
	t.Assert(dc, "dc");
	t.Assert(cd == dc, "cd == dc");
	t.Assert(cd.overlap.x == c.size.x - Fixed{2}, "cd.x == c.x-2");
	t.Assert(cd.overlap.y == c.size.y - Fixed{2}, "cd.y == c.y-2");
	...
	t.Assert(wbd.overlap.x == b.size.x - Fixed{1}, "wrap bd.x == b.x-1");
	t.Assert(wbd.overlap.y == b.size.y - Fixed{1}, "wrap bd.y == b.y-1");
	t.Assert(wcd, "cd");
	t.Assert(wdc, "dc");
	t.Assert(wcd == wdc, "wrap cd == dc");
	t.Assert(wcd.overlap.x == c.size.x - Fixed{2}, "wrap cd.x == c.x-2");
	t.Assert(wcd.overlap.y == c.size.y - Fixed{2}, "wrap cd.y == c.y-2");
}
